...
if (buttonStateTemp == LOW && buttonStateHumidity == LOW) generalFlag = 0;
...
if (buttonStateManual == LOW) flagManual = 0;
if (buttonStateAutomatic == LOW) flagAutomatic = 0;
  ...
  if (buttonStateTemp == LOW) flagTemp = 0;
  if (buttonStateHumidity == LOW) flagHumidity = 0;
